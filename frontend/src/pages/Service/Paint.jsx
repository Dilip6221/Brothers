      ...
      <div className="py-5 text-center">
        ...
        <div className="container text-center">
          <h3 className="section-title section-title-small">
            <span className="first-letter">P</span>aint Protection Film (PPF)
          </h3>
        </div>
      </div>
          ...
          <div className="row align-items-center g-5">
            ...
            <div className="col-lg-6">
              ...
              <p className="section-text">
                Paint Protection Film (PPF) is a virtually invisible,
            ...
            <div className="col-lg-6">
              <div className="ppf-image-wrapper">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-WMvzv5OMSudDl77Me-N1lCqMsDgrYMy6nw&s"
                  alt="PPF Installation"
                  className="ppf-img main-img"
                />
                <img
                  src="https://thedetailingcompany.in//uploads/Blog/175/DC_1711356871.jpg"
                  alt="PPF Closeup"
