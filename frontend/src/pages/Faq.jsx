...
const Faq = () => {
    ...
    const faqs = [
        ...
        { question: "Can you collect and deliver my car?", answer: "Yes. We offer pickup and drop services for selected locations." },
        { question: "Are you insured?", answer: "Absolutely. Every vehicle is professionally handled and protected." },
        { question: "Do I get a warranty or guarantee?", answer: "Yes. Selected detailing services and parts come with warranty coverage." },
        { question: "What is detailing?", answer: "Detailing is a premium restoration and deep cleaning process for your vehicle." }
    ];
                ...
                <div className="container">
                    <div className="faq-contact-grid">
                        ...
                        <div className="faq-contact-text">
                            ...
                            <p>Still confused? Our premium support team is ready to help you.</p>
                            <button className="premium-faq-btn" onClick={() => navigate("/contact-us")}>Contact Us</button>
                        </div>

                        {/* RIGHT */}
                        <div className="faq-contact-image">
                            <img src={cars} alt="RYDAX" onClick={() => { if (audioRef.current) { audioRef.current.currentTime = 0; audioRef.current.play(); } }} />
